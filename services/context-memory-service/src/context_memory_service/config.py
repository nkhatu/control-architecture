...
class AppSettings(BaseSettings):
    ...
    app_name: str = "context-memory-service"
    app_env: str = "local"
    host: str = "0.0.0.0"
    port: int = Field(default=8002, validation_alias="CONTEXT_MEMORY_SERVICE_PORT")
    auto_create_schema: bool = Field(default=False, validation_alias="CONTEXT_MEMORY_AUTO_CREATE_SCHEMA")

    database_url: str | None = Field(default=None, validation_alias="CONTEXT_MEMORY_DATABASE_URL")
    postgres_host: str = Field(default="localhost", validation_alias="POSTGRES_HOST")
    postgres_port: int = Field(default=5432, validation_alias="POSTGRES_PORT")
    postgres_db: str = Field(default="agentic_money_context", validation_alias="CONTEXT_POSTGRES_DB")
