...
- loads control-plane, capability, and agent registry data from `control-plane`, with local YAML fallback
- calls `policy-engine` for deterministic intake and release decisions
