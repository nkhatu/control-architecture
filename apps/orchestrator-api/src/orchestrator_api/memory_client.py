...
import httpx
from shared_contracts.tasks import ArtifactView, TaskContextView, TaskDetailView, TaskRecordsView, empty_task_records, merge_task_detail
...
class MemoryServiceHttpClient:
    ...
    def _provenance_records(self, task_id: str) -> TaskRecordsView:
        try:
        ...
        if response.status_code == 404:
            return empty_task_records(task_id)
